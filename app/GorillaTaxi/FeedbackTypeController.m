...
- (void)loadView {
    ...
    innovationButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:17];   
    ...
    commentButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:17];   
    ...
    problemButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:17];   
